# Data cleaning for bar-chart3, "Conservative and Progressive Media Stories Associate Socialism 
# with "Medicare for All" at Similar Rates" (analysis page)
...
with open('medicare-for-all_center-conservative-progressiv-stories_2019.csv', 'r') as f:
...
with open('clean_medicare-for-all_center-conservative-progressiv-stories_2019.json', 'w') as f:
