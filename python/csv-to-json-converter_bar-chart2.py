# Data cleaning for bar-chart2, "Conservative Media Stories Associate Socialism with Green New Deal at 
# More Than Twice the Rate of Progressive Media Stories" (analysis page)
...
with open('socialist-or-socialism-and-greennewdeal_all-conservative-progressive_19.csv', 'r') as f:
...
with open('clean_socialist-or-socialism-and-greennewdeal_all-conservative-progressive_19.json', 'w') as f:
